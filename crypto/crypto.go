...
// The signed message format is "from:to:amount" — matching the verification logic
// in the ledger package. Returns the hex-encoded signature or an error.
//
// Parameters:
//   - privateKeyHex: 128-char hex string (64-byte Ed25519 private key)
//   - from:          sender address (hex public key)
//   - to:            receiver address (hex public key)
//   - amount:        coin amount
